...
CUSTOM_MODEM=t861bev4_z_lwg_cotsx
...
############################### TEKSUN BEGIN#####################################
MTK_BUILD_VERNO = WE_R4_SW_V5.1
XUNHU_LPS_TEKHW_SUPPORT=yes
XUNHU_PROJECT_MEMORY_TYPE=37.12816
TEKSUN_DRIVE_COMMON_BOARD_DWS_NAME=T861BE_37M_V40
XUNHU_COMMON_CTS_CONFIG=yes
XUNHU_COMMON_CTS_FASTPASS_PLUS_CONFIG=yes
XUNHU_STREAM_SYSTEM=12
XUNHU_STREAM_RING=12
XUNHU_STREAM_MUSIC=12
XUNHU_STREAM_ALARM=12
XUNHU_STREAM_NOTIFICATION=12
XUNHU_DISTINGUISH_SIM_RING=yes
#设置型号名称
XUNHU_MODEL=WE R4
# 设置品牌名称
XUNHU_BRAND=WE
...
XUNHU_JP_SMS_DEFAULT_SIM=yes
XUNHU_CALL_DEFAULT_VIBRATE_RINGING=yes
XUNHU_SYSTEM_TIME_DEFAULT_24=no
#XUNHU_SETTING_RAM_VALUE=8
#XUNHU_SETTING_ROM_VALUE=1
XUNHU_SALE_TRACKER=yes
#作者:trf1205
#功能:配置client id
#使用方法:填写需求的client id,默认no
XUNHU_CUSTOM_CLIENT_ID=android-teksun
#功能:相机设置中显示对焦声音菜单
XUNHU_QTY_AF_SOUND_MENU=yes
XUNHU_ADD_SB_PHONESERVER=no
XUNHU_ADD_ZD_DYNAMICLOAD=no
...
#功能:设置默认时区
XUNHU_DEFAULT_TIMEZONE=Asia/Almaty
#功能:刷新flash时序的功能
#使用方法:yes/no,默认yes
#XUNHU_TTC_FLASH_ADAPTIVE_REFRESH=yes
#下拉状态栏快速设置ICON高亮颜色显示蓝色
#使用方法:yes/no yes:蓝色高亮　no:系统默认显示　
XUNHU_SYSTEMUI_QUICSETTING_BLUEICON=yes

XUNHU_SHOW_NETWORK_ICON=yes
#功能:智能唤醒画W进入google 短信
#使用方法:yes/no,默认no
XUNHU_W_INTO_GOOGLE_SMS=yes
#为双卡添加来电短信快速回执功能：无视设置中默认SIM卡，自动使用被叫卡回执短信（例SIM1来电，此时默认SIM2为默认短信发送卡，此时使用来电屏幕中的短信回执功能，仍通过SIM1发送）
#使用方法:yes/no yes:打开　no:关闭
XUNHU_INGORE_DEFAULT_MESSAGE_SIM=yes
#移除设置，无障碍菜单中字体大小，显示大小菜单功能
#使用方法:yes/no yes:隐藏　no:不隐藏
XUNHU_REMOVE_FONTSIZE_DISPSIZE=yes

#功能:工厂模式测试通过方可显示pass按钮
#使用方法:yes/no,默认no
XUNHU_FACTORYTEST_INVISIBLE_PASS_BUTTON=yes

#功能:工厂模式lcd测试七种颜色,打开则有7种,关闭默认5种
#使用方法:yes/no,默认no
XUNHU_FACTORYTEST_COLORTEST_7=yes

#功能:工厂模式增加硬件测试
#使用方法:yes/no,默认no
XUNHU_FACTORYTEST_ADD_HARDWARE_TEST=yes
#作者:TRF424
#功能:工厂模式相机测试增加拍照按键
#使用方法:yes/no,默认no
XUNHU_FACTORYTEST_ADD_TAKE_PHOTO=yes

#作者:TRF424
#功能:工厂模式增加内存测试
#使用方法:yes/no,默认no
XUNHU_FACTORYTEST_ADD_MEMORY_TEST=yes
XUNHU_RF_MODE=FDD3M
############################### TEKSUN END#####################################
